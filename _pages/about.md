...
<div style="max-width:640px; margin:3rem auto 0; clear:both; text-align:center; padding:2rem; background: linear-gradient(135deg, rgba(56, 189, 248, 0.06), rgba(99, 102, 241, 0.06)); border-radius:12px; border:2px solid rgba(56, 189, 248, 0.12);">
  ...
  <a href="https://vinkumbr.github.io/spon2026/" style="display:inline-block; padding:0.75rem 2rem; background:linear-gradient(135deg,#38BDF8,#6366F1); color:white; text-decoration:none; border-radius:8px; font-weight:600; transition:all 0.25s; box-shadow:0 6px 18px rgba(56,189,248,0.18);" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 8px 26px rgba(56,189,248,0.28)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 6px 18px rgba(56,189,248,0.18)';">
    ✨ Explore SPoN 2026 →
  </a>
</div>
---